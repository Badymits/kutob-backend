"""
Django settings for kutob_backend project.
...
SECRET_KEY = 'django-insecure-(l00l_aig#lk7t+q002t#9z65%p*g86$-a+d(!l8lvj8h_wl)c'
...
WSGI_APPLICATION = 'kutob_backend.wsgi.application'
